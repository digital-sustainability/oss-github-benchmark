...
export enum Method {
  ...
  PullRequestAll = 'get_github_pull_requests_all',
  PullRequestClosed = 'get_github_pull_requests_closed',
  IssueClosed = 'get_github_issues_closed',
  IssueAll = 'get_github_issues_all',
